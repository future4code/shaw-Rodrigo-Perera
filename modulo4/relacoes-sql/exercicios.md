...
a) O Foreign Key atribui uma key a nova tabela com base em uma KEY já existente de outra tabela. É como se atribuisse uma Key "estrabgeira" a tabela atual.
