...
class User {
  ...
  const newUser = new User("55544488811", "rodrigo@labenu.com", "Rodrigo", "123456")
  console.log(newUser.getId(), newUser.getEmail(), newUser.getName())


//   Exercício 1
//   a)
//   Somente se fizer uma função em que torna o atributo publico, igual faz com ID, Email e Name
//   b) Uma vez.
//   Exercício 2
  ...
  const newCustomer = new Customer("33344455566", "matheus@labenu", "Matheus", "123456", "57898778999785")
  console.log(newCustomer.getCreditCard(), newCustomer.getIntroduce())

  // a) 
  // Uma vez
  // b) 
  // Duas vezes, pois a classe Customer é uma subclasse da classe User, fazendo
  // com que ela seja chamada novamente antes da classe Customer ser chamada.

  // Exercício 3
  // console.log(`aqui é o novo usuario ${newCustomer}`)

  // a)
  // Não seria possível pois está privado pelo pai.

// Exercício 4/5
// Está feito no código
